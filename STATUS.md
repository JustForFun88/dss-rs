...
- **WP8.4 (Show reports) — step 12 COMPLETE, gate-green** (the EnergyMeter
  ...
  **743→744**. **next = continue WP8.4** (`Controlled`; the remaining CktTree families
  `Isolated`/`Topology`/`busflow` — need `GetTopology`/`GetIsolatedSubArea`;
  `LineConstants`).
...
cargo test --workspace      # dss-core lib 744, golden_feeders 1,
                            ...
                            # golden_phase7_protection 1, golden_phase8 103,
