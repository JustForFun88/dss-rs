...
- **WP8.4 (Show reports) — step 8 COMPLETE, gate-green** (the register tables):
  ...
  (deferred). **next = continue WP8.4** (Yprim + the active-ckt-element surface, then
  the overload/fault + CktTree families).
...
cargo test --workspace      # dss-core lib 732, golden_feeders 1,
                            ...
                            # golden_phase7_protection 1, golden_phase8 86,
