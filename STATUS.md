...
gate-green Phase-7 tip). **WP8.1–8.3 COMPLETE + audited; WP8.4 (Show) steps 1–4
gate-green (Buses/Losses/Taps/Voltages/Currents/Powers-seq + Voltages node/elem +
Currents elem + Elements + dispatcher).** Full Phase-8 detail is in **§1f**; the
current frontier:
...
cargo test --workspace      # dss-core lib 731, golden_feeders 1,
                            ...
                            # golden_phase7_protection 1, golden_phase8 69,
...
- **WP8.4 (Show reports) — step 4 COMPLETE, gate-green.** The remaining
  ...
  token-invariant, which is why steps 1–3 didn't surface it). **next: WP8.4 step 5**
  (`Show Powers` code 1 element form + the diagnostic/topology Shows).
