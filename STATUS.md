...
gate-green Phase-7 tip). **WP8.1–8.3 COMPLETE + audited; WP8.4 (Show) steps 1–9
...
**step 9: Overloads/Unserved** + dispatcher; ~23 `Show` reports ported).
**~8 `Show` reports remain** (all *silent* no-ops, `TODO(WP8)`: Controlled/Zone/
FaultStudy/Yprim/LineConstants/Isolated/Loops/Topology/busflow/
...
- **WP8.4 (Show reports) — step 9 COMPLETE, gate-green** (the overload/unserved
  ...
  **Remaining unported Show keywords** (all still *silent*
  ...
  no-ops), `deltaV` (deferred). **next = continue WP8.4** (FaultStudy, then Yprim +
  the active-ckt-element surface, then the CktTree families).
...
cargo test --workspace      # dss-core lib 732, golden_feeders 1,
                            ...
                            # golden_phase7_protection 1, golden_phase8 95,
