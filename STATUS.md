...
Current scores: dss-core **lib 729**, **`solvable_now` 119** (the live corpus gate;
...
cargo test --workspace      # dss-core lib 729, golden_feeders 1,
                            ...
                            # golden_phase7_protection 1, golden_phase8 43,
