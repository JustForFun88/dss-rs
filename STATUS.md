...
gate-green Phase-7 tip). **WP8.1–8.3 COMPLETE + audited; WP8.4 (Show) steps 1–11
...
`Select` command / active-ckt-element surface) + dispatcher; ~25 `Show` reports
ported).
**~6 `Show` reports remain** (all *silent* no-ops, `TODO(WP8)`: Controlled/Zone/
LineConstants/Isolated/Loops/Topology/busflow/
