...
gate-green Phase-7 tip). **WP8.1–8.3 COMPLETE + audited; WP8.4 (Show) step 1
gate-green (Buses/Losses/Taps + dispatcher).** Full Phase-8 detail is in **§1f**;
...
cargo test --workspace      # dss-core lib 731, golden_feeders 1,
                            ...
                            # golden_phase7_protection 1, golden_phase8 62,
