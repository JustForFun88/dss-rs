...
gate-green Phase-7 tip). **WP8.1–8.3 COMPLETE + audited; WP8.4 (Show) steps 1–10
...
step 9: Overloads/Unserved + **step 10: FaultStudy** + dispatcher; ~24 `Show`
reports ported).
**~7 `Show` reports remain** (all *silent* no-ops, `TODO(WP8)`: Controlled/Zone/
Yprim/LineConstants/Isolated/Loops/Topology/busflow/
