...
impl RPNCalculator {
    ...
    pub fn sin_deg(&mut self) {
        self.x = self.x.to_radians().sin();
    }

    pub fn cos_deg(&mut self) {
        self.x = self.x.to_radians().cos();
    }

    pub fn tan_deg(&mut self) {
        self.x = self.x.to_radians().tan();
    }

    pub fn asin_deg(&mut self) {
        self.x = self.x.asin().to_degrees();
    }

    pub fn acos_deg(&mut self) {
        self.x = self.x.acos().to_degrees();
    }

    pub fn atan_deg(&mut self) {
        self.x = self.x.atan().to_degrees();
    }

    pub fn atan2_deg(&mut self) {
        self.x = self.y.atan2(self.x).to_degrees();
        self.y = self.z;
        self.z = self.t;
        self.t = 0.0;
    }
...
impl DSSParser {
    ...
    pub fn next_param(&mut self) -> String {
        ...
        self.check_for_var(&mut self.token_buffer);
