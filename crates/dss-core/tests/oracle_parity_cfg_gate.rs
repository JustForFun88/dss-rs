...
fn every_pin_the_g13b_record_names_exists_and_is_cited() {
    ...
    const G13B_PINS: &[(&str, &str)] = &[
        ...
        (
            "the_seq_arm_population_holds_while_the_arm_stays_off_r4133",
            HARNESS,
        ),
        (
            "the_seq_arm_population_fires_when_the_arm_reaches_r4133",
            HARNESS,
        ),
        (
    ...
    const G13B_PIN_GROUPS: &[(&str, &str, usize, usize)] = &[
        ("exec::tests::derived_seq", ENGINE, 8, 8),
        ("harness::seq_floors", HARNESS, 35, 22),
    ];
    let root = repo_root();
    let prose: String = [
        "TESTING.md",
