...
const SKIP_PROPS: &[(&str, &str)] = &[
    ...
    //     `tests/TOLERANCE_NOTES.md:1783-1788` pins the r4133-side values and
    ...
    //     `tests/TOLERANCE_NOTES.md:1783-1788` says it outright ("The r4133 values
    ...
    //     witness it live — the same argument `tests/TOLERANCE_NOTES.md:1783-1788`
...
///    r4133 by construction, and `tests/TOLERANCE_NOTES.md:1783-1788` forbids
...
mod skip_props_disposition_tests {
    ...
    /// r4133 values (`RevThreshold`, Fuse) `tests/TOLERANCE_NOTES.md:1783-1788`
