...
/// 523 cases → 519 live → **440** forced once the 79 live `kind=large*` decks
/// come off, of which 313 are `both`, 83 r4133-only and 44 capi-only (measured
/// 2026-09-05). Identical to [`FORCED_PROPS_POPULATION`] by construction, and
...
const FORCED_TOPOLOGY_POPULATION: (usize, usize, usize, usize) = (440, 313, 83, 44);
