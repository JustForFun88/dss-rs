...
- **G1.3a** (2026-09-04, lane `lane-e`; coordinator decisions D3/D4/D7/D10) — **WP-G1's first
  ...
  (`WP_G1_MODES` 96 → **97**). Floors are derived images of the disc `assert_complex_close_c` already
...
- **G1.3d(i)** (2026-09-04/05, lane `lane-e`; D4/D7/D19/D19′) — per-element `NumTerminals`/
  ...
  normalization — the no-meter sentinel, folded per channel. Forced on **440** cases
  (`FORCED_ELEMENT_EXTRAS_POPULATION` `(440, 313, 83, 44)`). Pins: `exec::tests::element_extras::*`
