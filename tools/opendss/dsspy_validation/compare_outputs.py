...
# tests/compare_outputs.py, branch fastdss (0.16.0b2), BSD-3-Clause — see
# LICENSE. Kept as upstream (KNOWN_COM_DIFF + tolerance categories encode
# hard-won EPRI-vs-dss_capi knowledge); pandas/xmldiff are pinned in the
# Oddie venv (tools/opendss/PIN_OPENDSS.txt). Local modifications, if any,
# are marked "# dss-rs:".
