# build_wm4model_wasm.ps1 — rebuild the committed golden-class fixture
# tests/fixtures/wasm/wm4model.wasm (WASM_USERMODELS_PLAN §2.6, WP-WM.4).
#
...
# recorded in PIN.txt.
#
# Usage:  pwsh tools/wasm_usermodel/build_wm4model_wasm.ps1
...
Copy-Item (Join-Path $Crate "target\wasm32-unknown-unknown\release\wm4model.wasm") $Artifact -Force
