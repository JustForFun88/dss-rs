...
_Generated 2026-06-14 12:18:41 UTC by
...
| `skipped_needs_investigation` | 8 |
| `skipped_oracle_issue` | 40 |
| `skipped_unsupported` | 270 |
| `solvable_now` | 16 |
| **total** | **915** |

- **Runnable entry points:** 335 (everything except `not_an_entry_point`).
- **Live-compared now (`solvable_now`):** 16 — **4.8%** of entry points.
